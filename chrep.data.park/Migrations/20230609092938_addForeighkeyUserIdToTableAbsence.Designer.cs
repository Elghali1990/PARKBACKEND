...
namespace chrep.data.park.Migrations
{
    ...
    [Migration("20230609092938_addForeighkeyUserIdToTableAbsence")]
    partial class addForeighkeyUserIdToTableAbsence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("chrep.core.park.Models.Absence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("chrep.core.park.Models.Absence", b =>
                {
                    b.HasOne("chrep.core.park.Models.Mission", "Mission")
                        .WithMany("Absences")
                        .HasForeignKey("MissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("chrep.core.park.Models.User", "User")
                        .WithMany("Absences")
